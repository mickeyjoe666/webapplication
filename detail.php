...
$query="select * from  election e,candidates c,attend a where e.id=$1 and a.election=e.id and a.candidate = c.cid";
$result =pg_prepare($conn,"get_election",$query);
$result =pg_execute($conn,"get_election",array($electionid));
